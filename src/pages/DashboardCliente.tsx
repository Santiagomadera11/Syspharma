...
import { Search, SlidersHorizontal, ShoppingBag, X, Check, ChevronLeft, ChevronRight } from 'lucide-react';
...
const PRODUCTOS_MOCK: Producto[] = [
  ...
  },
  {
    ...
    precio: 6500,
    imagen: 'https://images.unsplash.com/photo-1585435557343-3b092031a831?w=400',
  ...
  },
  {
    ...
    precio: 55000,
    imagen: 'https://images.unsplash.com/photo-1603791239531-3712381c2c18?w=400',
    categoria: 'Primeros Auxilios y Curación'
  },
  {
    id: '9',
    ...
    precio: 42000,
    precioUnidad: 1050,
    imagen: 'https://images.unsplash.com/photo-1515488042361-ee00e0ddd4e4?w=400',
...
export default function DashboardCliente({ user }: DashboardClienteProps) {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-8 py-12">
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="space-y-6">
              <h1 style={{ fontSize: '48px', fontWeight: 800, color: '#1F2937', lineHeight: '1.1' }}>
                Tu farmacia<br />de confianza
              </h1>
              ...
              <div className="flex flex-wrap gap-4">
                <div className="flex items-center gap-3 bg-white rounded-full px-5 py-3 shadow-sm">
                  ...
                  <span style={{ color: '#374151', fontWeight: 600 }}>Envío gratis</span>
                </div>
                <div className="flex items-center gap-3 bg-white rounded-full px-5 py-3 shadow-sm">
                  <div className="w-10 h-10 rounded-full bg-teal-500 flex items-center justify-center">
                    <span className="text-white text-lg">✓</span>
                  </div>
                  <span style={{ color: '#374151', fontWeight: 600 }}>Entrega rápida</span>
                </div>
                <div className="flex items-center gap-3 bg-white rounded-full px-5 py-3 shadow-sm">
                  <div className="w-10 h-10 rounded-full bg-teal-500 flex items-center justify-center">
                    <span className="text-white text-lg">✓</span>
                  </div>
                  <span style={{ color: '#374151', fontWeight: 600 }}>Productos originales</span>
                </div>
              </div>
              ...
              <button
                ...
                style={{ backgroundColor: '#14B8A6', fontSize: '16px', fontWeight: 700 }}
              >
                EXPLORAR PRODUCTOS
              </button>
            </div>
            ...
            >
              <div className="p-6">
                ...
                <div className="relative mb-4">
                  <Search className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400" style={{ width: '18px', height: '18px' }} />
                  <input
                    type="text"
            ...
            >
              <div className="relative aspect-square overflow-hidden bg-gray-50">
                ...
                {producto.nuevaImagen && (
                  <div className="absolute top-3 left-3 px-3 py-1 rounded-full text-xs text-white bg-orange-500" style={{ fontWeight: 600 }}>
                    NUEVA IMAGEN
                  </div>
                )}
                {producto.recetaMedica && (
                  <div className="absolute top-3 left-3 px-3 py-1 rounded-full text-xs text-white bg-red-500" style={{ fontWeight: 600 }}>
                    Receta médica
                  </div>
                )}
              </div>
              ...
              <div className="p-4">
                <h3 style={{ fontSize: '14px', fontWeight: 700, color: '#1F2937', lineHeight: '1.4', marginBottom: '8px' }} className="line-clamp-2">
                  {producto.nombre}
                </h3>
                
                <p style={{ fontSize: '22px', fontWeight: 800, color: '#1F2937', marginBottom: '4px' }}>
                ...
                <button
                  ...
                  style={{ backgroundColor: '#14B8A6', fontSize: '14px', fontWeight: 700 }}
                >
                  + Añadir al pedido
                </button>
              </div>
          ...
          <div className="flex items-center justify-center gap-2">
            ...
            {Array.from({ length: totalPages }, (_, i) => i + 1).map(page => (
              <button
                ...
                style={{
                  backgroundColor: currentPage === page ? '#14B8A6' : 'transparent',
      ...
      >
        <ShoppingBag className="text-white" style={{ width: '24px', height: '24px' }} />
        {cart.length > 0 && (
            ...
            >
              <div className="p-6 border-b-2 border-gray-100">
                <div className="flex items-center justify-between">
                  <h3 style={{ fontSize: '24px', fontWeight: 800, color: '#1F2937' }}>
                    Mi Pedido
                  </h3>
                  <button
                    onClick={() => setShowCart(false)}
              ...
              <div className="flex-1 overflow-y-auto p-6">
                {cart.length === 0 ? (
                  <div className="flex flex-col items-center justify-center h-full text-center">
                    <ShoppingBag className="text-gray-300 mb-4" style={{ width: '64px', height: '64px' }} />
                    <p style={{ fontSize: '18px', fontWeight: 600, color: '#9CA3AF' }}>
                  ...
                  <div className="space-y-4">
                    {cart.map(item => (
                      <div key={item.id} className="flex gap-4 p-4 rounded-xl border-2 border-gray-100">
                        <img
                          src={item.imagen}
                          alt={item.nombre}
                        ...
                        <div className="flex-1">
                          <h4 style={{ fontSize: '14px', fontWeight: 600, color: '#1F2937', marginBottom: '4px' }} className="line-clamp-2">
                            {item.nombre}
                          </h4>
                          <p style={{ fontSize: '16px', fontWeight: 700, color: '#14B8A6', marginBottom: '8px' }}>
              ...
              {cart.length > 0 && (
                <div className="border-t-2 border-gray-100 p-6 space-y-4">
                  <div className="flex items-center justify-between">
                    <span style={{ fontSize: '18px', fontWeight: 600, color: '#6B7280' }}>Total:</span>
