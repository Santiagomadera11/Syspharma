            ...
            <form onSubmit={handleVerifyCode} className="space-y-5">
              <div>
                ...
                <p
                  ...
                  style={{ fontSize: "11px" }}
                >
                  💡 Para esta demo, usa el código:{" "}
                  <span className="text-[#63E6BE]" style={{ fontWeight: 600 }}>
                    123456
                  </span>
                </p>
              </div>
        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              {touched.email && errors.email && (
                <p
                  className="text-red-400 mt-1.5 flex items-center gap-1"
                  style={{ fontSize: "12px" }}
                >
            ...
            <div className="mt-8 p-4 rounded-xl bg-[#2D3748] border-2 border-[#4A5568]">
              ...
              >
                <div>
                  <p className="text-[#63E6BE]" style={{ fontWeight: 600 }}>
                    Administrador:
                  </p>
