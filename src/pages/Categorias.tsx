...
export default function Categorias({ user }: CategoriasProps) {
  ...
  useEffect(() => {
    ...
    const mapped = categoriasFromStorage.map((c, index) => ({
      ...
      color:
        c.color ||
        COLORES_PREDEFINIDOS[index % COLORES_PREDEFINIDOS.length].valor,
  ...
  const toggleEstado = (categoria: Categoria) => {
    ...
    toast.success(
      `Categoría ${
        newEstado === "Activa" ? "activada" : "desactivada"
      } exitosamente`,
      {
        style: {
  ...
  return (
    <div className="space-y-6">
            ...
            <thead className="bg-gradient-to-r from-[#14B8A6] to-[#0EA5E9]">
              <tr>
                <th
                  ...
                  style={{ fontWeight: 600, fontSize: "14px", width: "40px" }}
                >
        ...
        {totalPages > 1 && (
          ...
          >
            <p className={textSecondary} style={{ fontSize: "14px" }}>
              ...
              {Math.min(currentPage * itemsPerPage, filteredCategorias.length)}{" "}
              de {filteredCategorias.length} categorías
            </p>
      ...
      <Dialog open={modalOpen} onOpenChange={setModalOpen}>
        <DialogContent
          className={`${modalBg} max-w-md w-full mx-auto rounded-xl border-2 ${border} p-6`}
        >
          <DialogHeader>
          ...
          <form onSubmit={handleSubmit} className="mt-6 space-y-5">
            ...
            <div className="space-y-3">
              ...
              {/* Preview del badge */}
              <div
                className={`p-4 rounded-xl border-2 border-dashed ${border}`}
              >
                <p
        ...
        >
          <AlertDialogHeader>
            ...
            <AlertDialogDescription
              ...
              style={{ fontSize: "14px" }}
            >
              Los productos asociados ({selectedCategoria?.productosCount || 0})
              pasarán a categoría "Sin categoría". Esta acción no se puede
              deshacer.
            </AlertDialogDescription>
          </AlertDialogHeader>
