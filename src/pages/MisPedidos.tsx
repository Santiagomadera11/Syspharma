              ...
              <div className="p-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="text-right">
                    <div
                      className={`inline-flex items-center gap-2 px-3 py-1.5 rounded-full ${estadoStyle.bg} border ${estadoStyle.border}`}
                    >
                      <span
                        className={`${estadoStyle.text} text-xs`}
                ...
                <div
                  ...
                  style={{
                    borderColor: isDark ? "rgba(99, 230, 190, 0.1)" : "#e5e7eb",
                  }}
                >
                  <div>
                    <p className={textSecondary} style={{ fontSize: "12px" }}>
              ...
              <div>
                ...
                <div className="space-y-2">
                  {selectedPedido.productos.map((producto) => (
                    <div
                      key={producto.id}
                      className={`p-3 rounded-xl border ${border} flex items-center justify-between`}
                    >
                      <div>
                        <p
                          className={textPrimary}
